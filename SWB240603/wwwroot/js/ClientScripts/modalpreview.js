...
$(document).ready(function () {
    ...
    $("#preview-btn").on("click", function () {
        ...
        var availedBenifit = $("input[name='Applicant.Reservation.ExService.IsAvaliedExServiceBenefit']:checked").val(); //23
        var EducationExsericeman = $("#Applicant_Reservation_ExService_ExServiceEducationalQualificationCode option:selected").text(); //23b
        ...
        var YearofPassingSSLC = $("#Applicant_EducationalQualification_SSLCQualification_YearOfPassing option:selected").text();  //32
        ...
        var SSLCManualPercentageObtained = $(".manual-percentage").val(); //33a
        ...
        $("#availedBenefitPreview").text(availedBenifit);
        $("#eduQualificationexserPreview").text(EducationExsericeman);
        ...
        $("#SSLCManualPercentageObtainedPreview").text(SSLCManualPercentageObtained);

...
builder.Services.AddTransient<IExServiceEducationalQualificationService, ExServiceEducationalQualificationService>();
builder.Services.AddTransient<IExServiceForceService, ExServiceForceService>();
builder.Services.AddTransient<IExServicemenRelationService, ExServicemenRelationService>();
builder.Services.AddTransient<IKalyanaKarnatakaDistrictService, KalyanaKarnatakaDistrictService>();
builder.Services.AddTransient<IApplyingTypeService, ApplyingTypeService>();

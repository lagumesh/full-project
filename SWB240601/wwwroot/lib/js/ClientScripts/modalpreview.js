    ...
    $("#preview-btn").on("click", function () {
        ...
        if (!$('#applicationForm').valid()) {
            Swal.fire({
                ...
                text: "Fill all the details required.",
                icon: "error",
        ...
        var gender = $("input[name='Applicant.Reservation.Gender']:checked").val();
        ...
        var PerDistrict = $("#Applicant_NativeDistrict").text(); //20g
        var PerOtherDist = $("#Applicant_PermanentAddress_OtherDistrictName").val(); //20g
        var PerState = $("#Applicant_PermanentAddress_UnionStateCode").val(); //20g
        ...
        var presentlyExServicemen = $("#Applicant_Reservation_ExService_ExServiceForceCode").val(); //23
        ...
        var RelatedExservicemen = $("input[name='Applicant.Reservation.ExServiceRelation']:checked").val();
        var ExServicemenRelation = $("#Applicant_Reservation_ExServiceRelation_ExServicemenRelationCode option:selected").text(); //24
        var ExServicemenDiedinAction = $("input[name='Applicant.Reservation.ExServiceRelation.IsDiedInService']:checked").val();   //24b
        var ExServicemenDisabled = $("input[name='Applicant.Reservation.ExServiceRelation.IsDisabledInService']:checked").val(); //24c
        ...
        var KannadaMediumReservation = $("input[name='Applicant.Reservation.IsClaimingKannadaMediumReservation']:checked").val(); //26
        var KannadaMediuCertificate = $("#Applicant_Reservation_KannadaMediumCertificateIssuedDate").val(); //26a

        var TransgenderReservation = $("input[name='Applicant.Reservation.IsClaimingTransgenderReservation']:checked").val(); //27
        var TransgenderReservationCertificate = $("#Applicant_Reservation_TransgenderCertificateIssuedDate").val(); //27a

        var KalyanaKarnataka = $("input[name='Applicant.Reservation.IsClaimingKalyanaKarnatakaReservation']:checked").val(); //28
        var KalyanaKarnatakaDistrict = $("#Applicant_Reservation_KalyanaKarnatakaDistrictCode").val(); //28a
        ...
        var PassedSSLC = $("input[name='Applicant.EducationalQualification.SSLCQualification.QualificationBoard.IsApplicableForSSLC']:checked").val();  //31
        var KannadaLanguage = $("#Applicant_EducationalQualification_SSLCQualification_KannadaLanguagePaper").val(); //31a
        ...
        var SSLCMarksorGrades = $("input[name='Applicant.EducationalQualification.SSLCQualification.Score']:checked").val(); //33a
        ...
        var PassedPUC = $("input[name='Applicant.EducationalQualification.PUCQualification.QualificationBoard.IsApplicableForPUC']:checked").val();  //31
        ...
        $("#RelationShipwithExServicemenPreview").text(RelatedExservicemen);
        ...
        $("#SSLCMarksorGradesPreview").text(SSLCMarksorGrades);

$(document).ready(function (e) {
   ...
   function restrictSpecialCharacters(value, element) {
    ...
    }, "Please enter a valid grade pattern.");
    ...
    $("#applicationForm").validate({
        rules: {
            ...
            "Applicant.ApplicantTypistAssistant": {
                required: function (element) {
            ...
            "Applicant.ApplicantStenographerAssistant": {
                required: function (element) {
            ...
            "Applicant.ApplicantTypistAssistant.QualificationCode": {
                required: function (element) {
                    return $('#Applicant_ApplicantTypistAssistant').val() === 'True';
                },
            },
            "Applicant.ApplicantStenographerAssistant.QualificationCode": {
                required: function (element) {
                    return $('#Applicant_ApplicantStenographerAssistant').val() === 'True';
                },
            },
        ...
        messages: {
            ...
            "Applicant.ContactAddress.Street": {
                ...
                minlength: "Street should consists of atleast 1 characters.",
                maxlength: "Street should not exceed 15 characters.",
            },
            "Applicant.ContactAddress.Landmark": {
            ...
            "Applicant.Reservation.SubCaste": {
                ...
                maxlength: "subcaste shoult not exceed 60 characters.",

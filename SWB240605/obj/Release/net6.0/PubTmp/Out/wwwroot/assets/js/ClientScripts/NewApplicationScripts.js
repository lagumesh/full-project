...
$(document).ready(function () {
    ...
    // Event handler for the passed radio buttons
    $('input[name="Applicant.ApplicantTypistAssistant"]').change(function () {
        var selectedValue = $(this).val();
    ...
    // Event handler for the marks radio buttons
    $('input[name="Applicant.ApplicantStenographerAssistant"]').change(function () {
        var selectedValue = $(this).val();
...
$(document).ready(function () {
    ...
    $('#Applicant_PostUnitCode').change(function () {
        ...
        if (selectedVal === 'ST') {
            ...
            $('#steno_marks').hide()
            $('#typist_marks').hide()
            $('#Applicant_ApplicantTypistAssistant').prop("checked", false);
            $('#Applicant_ApplicantStenographerAssistant').prop("checked", false);

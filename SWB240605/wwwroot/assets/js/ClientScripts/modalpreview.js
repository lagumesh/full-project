...
$(document).ready(function () {
    ...
    $("#preview-btn").on("click", function (event) {
        ...
        if ($("input[name='Applicant.EducationalQualification.IsPUCHolder']:checked").val() === "False") {
            Swal.fire({
                title: "You are Not Eligibel",
                text: "PUC Education Required for this post.",
                icon: "error",
                confirmButtonColor: "#3085d6",
                confirmButtonText: "OK"
            }); return false;
        ...
        var typist1 = $("input[name='Applicant.ApplicantTypistAssistant.IsPassedInQualifyExam']:checked").val();
        var shorthandtypist1 = $('input[name="Applicant.ApplicantStenographerAssistant.IsPassedInQualifyExam"]:checked').val();
        ...
        var IDCardSelected = $("#Applicant_IdentityCardTypeCode option:selected").text(); //33a
